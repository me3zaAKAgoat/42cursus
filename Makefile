...
CURSUS_FUNCTIONS_SOURCES = ./src/cursus_functions/ft_atol.c ./src/cursus_functions/ft_split.c ./src/cursus_functions/ft_strlen.c \
./src/cursus_functions/ft_substr.c ./src/cursus_functions/ft_memcpy.c ./src/cursus_functions/ft_strlcpy.c\
./src/cursus_functions/ft_strncmp.c
...
./src/parsing/util.c ./src/parsing/wrexit.c
...
CURSUS_FUNCTIONS_OBJECTS = $(CURSUS_FUNCTIONS_SOURCES:.c=.o)
...
$(NAME) : $(MAIN_OBJECT) $(LINKED_LIST_OBJECTS) $(CURSUS_FUNCTIONS_OBJECTS) $(CORE_MODULES_OBJECTS) $(STACK_UTIL_OBJECTS)
	$(CC) $(CFLAGS) -o $(NAME) $(MAIN_OBJECT) $(LINKED_LIST_OBJECTS) $(CURSUS_FUNCTIONS_OBJECTS) $(CORE_MODULES_OBJECTS) $(STACK_UTIL_OBJECTS)

bonus : $(BONUS_OBJECTS) $(LINKED_LIST_OBJECTS) $(CURSUS_FUNCTIONS_OBJECTS) $(CORE_MODULES_OBJECTS) $(STACK_UTIL_OBJECTS)
	$(CC) $(CFLAGS) -o $(BONUS_NAME) $(BONUS_OBJECTS) $(LINKED_LIST_OBJECTS) $(CURSUS_FUNCTIONS_OBJECTS) $(CORE_MODULES_OBJECTS) $(STACK_UTIL_OBJECTS)

%.o : %.c $(HEADERS)
	$(CC) $(CFLAGS) -I./includes -c $< -o $@

clean :
	rm -f $(MAIN_OBJECT) $(BONUS_OBJECTS) $(LINKED_LIST_OBJECTS) $(CURSUS_FUNCTIONS_OBJECTS) $(CORE_MODULES_OBJECTS) $(STACK_UTIL_OBJECTS)

fclean : clean
	rm -f $(NAME) $(BONUS_NAME) $(MAIN_OBJECT) $(BONUS_OBJECTS) $(LINKED_LIST_OBJECTS) $(CURSUS_FUNCTIONS_OBJECTS) $(CORE_MODULES_OBJECTS) $(STACK_UTIL_OBJECTS)
